...
class ClassificationHead(nn.Module):
    ...
    def forward(self, query, support, support_labels, n_way, n_shot, **kwargs):
        if self.enable_scale:
            scores = self.scale * self.head(query, support, support_labels, n_way, n_shot, **kwargs)
        else:
            scores = self.head(query, support, support_labels, n_way, n_shot, **kwargs)

        # print(query.shape, support.shape, support_labels.shape, n_way, n_shot, scores.shape)
