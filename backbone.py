        ...
        for i in range(4):
            ...
            for j in range(list_of_num_layers[i]):
                ...
                if i == 3 and j == list_of_num_layers[i] - 1:
                    B = block(indim, list_of_out_dims[i], half_res, need_relu=not del_last_relu)
...
class BasicBlockTapNet(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm_layer=None, dropout_p=0.3, del_last_relu=False):
        ...
        self.del_last_relu = del_last_relu
...
class ResNetTapNet(nn.Module):
    ...
    def __init__(self, output_dim, del_last_relu=False):
        ...
        self.final_feat_dim = output_dim
